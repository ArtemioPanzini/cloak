...
Решение source-agnostic: одинаковые правила применяются ко всем посетителям. Проект не пытается распознавать модераторов рекламной платформы и не предназначен для обхода review.
